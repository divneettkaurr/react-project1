...
const Section4 = () => {
  return (
    ...
    <div className='relative mt-15'>
        ...
        <div className='absolute flex-col pl-10 sm:pl-0 sm:items-center top-23 sm:top-1/4 flex sm:flex-row gap-20 md:gap-27 left-9 right-10 md:left-55 '>

            <div className='flex sm:flex-col gap-9 items-center'>
                <FaUserDoctor className='h-35 w-35 md:h-50 md:w-45 text-white'/>
                <div className='flex flex-col gap-5 sm:gap-7 md:gap-10 items-center'>
            ...
            <div className='flex sm:flex-col gap-9 items-center'>
                <FaUserFriends className='h-35 w-35 md:h-50 md:w-45 text-white'/>
                <div className='flex flex-col gap-5 sm:gap-7 md:gap-10 items-center'>
