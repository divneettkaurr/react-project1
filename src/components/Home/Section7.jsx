    ...
    <div>
        <div className='text-[#5B8291] flex flex-col items-center p-20 pl-15 pr-15 md:p-30 gap-15 md:pl-40 md:pr-40'>
            ...
            <div className='text-lg md:text-xl text-center flex flex-col gap-5'>
                ...
                <div>
                    <p>n addition to his clinical work, he has played an active role in training medical residents, leading clinical audits, and contributing to international conferences and research. His commitment to continuous learning and quality improvement reflects his dedication to raising pediatric care standards</p>
                </div>
                <div>
